...
import type { Cookie as _Cookie } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async getAllCookies(): Promise<Array<Cookie>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCookies();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCookieById(arg0: bigint): Promise<Cookie | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCookieById(arg0);
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Cookie]): Cookie | null {
